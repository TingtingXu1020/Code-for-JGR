...
C FOR CRACKS
C      PARAMETER(AINICRACK=1000.0D0,CINICRACK=10.0D0)
...
C      
     ...
     8 J0(3,3,3,3)     
       DOUBLE PRECISION TEMP11, TEMP12, TEMP13
C
C   FOR DAMAGE
...
C    THE VOLUME OF WEATHERED BIOTITE
          tref = 1.0D0
          WRCT = 0.0D0
          IF ((TIME(2)-tref).GE.0.0D0 .AND.
     &         (COORDS(2) + 10.0D0*COS(PI/20.0D0*COORDS(1)))>70) THEN
		WRCT=10**(-12.32D0)*((TIME(2)))**(-0.603)*(COORDS(2)
     &     - 70.0D0 + 10.0D0*COS(PI/20.0D0*COORDS(1)))/
     &     (30.0D0 + 20.0D0*COS(PI/20.0D0*COORDS(1)))
c    Surface	
...
C    Volume
     ...
     & *(TIME(2)*TERVAL)**(0.397)/TEMP12*(COORDS(2)
     &     - 70.0D0 + 10.0D0*COS(PI/20.0D0*COORDS(1)))/
     &     (30.0D0 + 20.0D0*COS(PI/20.0D0*COORDS(1)))
          END IF    
